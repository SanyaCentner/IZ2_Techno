...
int parallel(const char *file_with_names, const char *file_with_mailers, const char *file_with_recipients,
              ...
              char *result_name, int size_letters, int size_mailer,  char date_start[12],
             char date_finish[12]);
...
int search_max(Names *names, segment *segments, int child_count, char result_name[25], int size_mailer);
